...
<body>
   ...
   <div class="login_container" style="margin-top:2rem; width:80vw">
        <h3 class="intro">Create an Employee Certification Profile!</h3>
        <div class="login_box">
            <form method="post" class="row g-3" id="form" style="padding-bottom:10rem;" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                ...
                <div class="col-12 account">
                    <input type="submit" name="submitBtn" class="btn create_account btn-lg btn-primary" value="Create Profile">
                </div>
            </form>
        </div>
      </div>
