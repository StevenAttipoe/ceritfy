...
<body>
      ...
      <div class="mainUpSkill">
        <div class="sidebarUpSkill">
              <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 240px; height:92vh;">
                    ...
                    <li>
                    <a href="upskill.php" class="nav-link active">
      ...
      <div class="tableUpSkill">
            <h2>Skills Acquisition Management Portal</h2>
                ...
                <tbody>
                  ...
                  ?>
                      <?= "<tr> <th>" . $value['Staff_ID'] . "</th> <td>" . $value['fullName'] ."</td> <td>". $value['email']  ."</th> <td>" . $value['department'] . "</td>"?>  
                        <td>
                          <a href="../functions/staff_delete.php?id=<?= $value['Staff_ID'] ?>" class="btn btn-danger btn-custom"> Delete</a> 
                          <a href="update.php?id=<?= $value['Staff_ID'] ?>" class="btn btn-secondary btn-custom"> Update</a> 
                        </td>
                  <?php
                      }
                  ?>
