...
<body style="background-color: #eeee;">
      ...
      <div class="mainPortal">
            <div class="portalSideBar">
                  <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 240px; height:92vh;">
                        <ul class="nav nav-pills flex-column mb-auto">
                              <li class="nav-item">
                                    <a href="portal.php" class="nav-link active" aria-current="page">
            ...
            <div class="portalDashboard">
                  ...
                  <div class = "dashboardImg" style="margin-left:23rem;height:25rem;">
                        <img style="max-height:100%;max-width:100%" src="../img/teams.svg" alt="teamwork photo">
                  </div>
            </div>
      </div>
</body>
